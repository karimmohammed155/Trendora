...
//Employees:
//add new employee
export const addNewEmployee = joi
  .object({
...
//update employee
export const updateEmployee = joi
  .object({
...
//delete employee
export const deleteEmployee = joi
  .object({
    id: joi.custom(isValidObjectId).required(),
  })
  .required();
...
export const getEmployeeById = joi
  .object({
    id: joi.custom(isValidObjectId).required(),
  })
  .required();
...
//Departments
//add new department
export const addNewDepartment = joi
  .object({
...
//update department
export const updateDepartment = joi
  .object({
    id: joi.custom(isValidObjectId).required(),
    name: joi.string().min(2).max(100).required(),
  })
...
//delete department
export const deleteDepartment = joi
  .object({
    id: joi.custom(isValidObjectId).required(),
  })
  .required();
...
//leaves::
//update leave
export const updateLeaveSchema = joi
  .object({
    id: joi.custom(isValidObjectId).required(),
...
//delete leave
export const deleteLeaveSchema = joi
  .object({
    id: joi.custom(isValidObjectId).required(),
  })
  .required();
...
export const generatePayrollSchema = joi
  .object({
    id: joi.custom(isValidObjectId).required(),
...
//get payroll by id
export const getPayrollByIdSchema = joi
  .object({
    id: joi.custom(isValidObjectId).required(),
  })
  .required();
...
//update payroll
export const updatePayrollSchema = joi
  .object({
...
export const deletePayrollSchema = joi
  .object({
    id: joi.custom(isValidObjectId).required(),
  })
  .required();
