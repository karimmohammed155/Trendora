...
router.post('/leaves', (0, _validationMiddleware.validation)(_dashboardSchema.addLeaveSchema), _dashboardController.addLeave); //Add ticket

router.post('/tickets', (0, _validationMiddleware.validation)(_dashboardSchema.addTicketSchema), _dashboardController.addTicket);
var _default = router;
